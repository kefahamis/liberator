                 ...
                 <div class="col-12 d-flex align-items-center justify-content-center">
                     <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-800">
                         <div class="text-center text-md-center mb-4 mt-md-0">
                             <img src="{{ asset('assets/img/liberator-app.svg') }}" alt="Image" width="100" height="" />
                         ...
                         <form wire:submit.prevent="register" action="#" method="POST">
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="form-group mb-4">
                                     ...
                                     <div class="input-group">
                                         <span class="input-group-text" id="basic-addon4"><svg class="icon icon-xs text-gray-600" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                 ...
                                 <div class="form-group mb-4">
                                     ...
                                     <div class="input-group">
                                         <span class="input-group-text" id="basic-addon5"><svg class="icon icon-xs text-gray-600" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                 <path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd"></path>
                                             </svg></span>
                                 ...
                                 <div class="form-group mb-4">
                                     <label for="user">What is your role</label>
