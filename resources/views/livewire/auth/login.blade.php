            ...
            <div wire:ignore.self class="row justify-content-center form-bg-image" >
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                        <a href="#" class="signup">Sign Up Later</a>
                        <div class="text-center text-md-center mb-4 mt-md-0">
                            <h1 class="mb-3 h3">Liberator</h1>
                            <p class="mb-0"> Book the best corporate events
                        ...
                        <p><strong>Sign up or Login with</strong></p>
                        ...
                        <div class="d-flex justify-content-center align-items-center mt-4">
                            <span class="fw-normal">
                                <p>By creating an account, you accept Liberator’s <strong style="color:#0086F8;">Terms of
                                        Service</strong> and <strong style="color:#0086F8;"> Privacy Policy</strong></p>
                            </span>
                        </div>
                    </div>
                </div>
